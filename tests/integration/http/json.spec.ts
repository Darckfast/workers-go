...
describe("fetch", () => {
    ...
    describe('POST /application/json should return JSON with payload info', () => {
        ...
        beforeAll(async () => {
            ...
            rs = await SELF.fetch("http://service/application/json?id=0.5385553010283278&uuid=6430d5f6-a1a8-48fb-9fe3-747c1d5d9ecb", {
                method: "POST",
                headers: {
                    "x-test-id": testid,
        ...
        it.each([
            ['size', 84],
            ['query', 'id=0.5385553010283278&uuid=6430d5f6-a1a8-48fb-9fe3-747c1d5d9ecb'],
            ['header', testid],
            ['raw', "{\"bool\":true,\"list\":[1,2,3,4,5,6],\"number\":1,\"string\":\"my super string\"}"]
