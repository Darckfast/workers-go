...
describe("email", () => {
  ...
  beforeAll(async () => {
    ...
    const r = await fetch('https://gist.githubusercontent.com/billsinc/967795/raw/8c7c36615f33380f923c575d4e27a5ae03f10ef7/Test%2520Email%2520from%2520PHPClasses')
  ...
  it('should have returned x-test-id', () => {
    expect(called.forward.headers.get('x-test-id')).toBe('12345-asdfg-56789-ghjkl')
  })

  it('should have returned the forwarded email', () => {
